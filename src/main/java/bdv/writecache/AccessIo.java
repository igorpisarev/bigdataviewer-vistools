...
import static bdv.writecache.AccessIo.PrimitiveType.BYTE;
import static bdv.writecache.AccessIo.PrimitiveType.CHAR;
import static bdv.writecache.AccessIo.PrimitiveType.DOUBLE;
import static bdv.writecache.AccessIo.PrimitiveType.FLOAT;
import static bdv.writecache.AccessIo.PrimitiveType.INT;
import static bdv.writecache.AccessIo.PrimitiveType.LONG;
import static bdv.writecache.AccessIo.PrimitiveType.SHORT;
...
public interface AccessIo< A >
{
	...
	public static < T extends NativeType< T >, A > AccessIo< A > get( final T type, final Flags ... flags )
	{
		...
		{}
		return get( primitiveType.get(), flags );
	}

	public static < A > AccessIo< A > get( final PrimitiveType primitiveType, final Flags ... flags )
	{
		final boolean dirty = Arrays.asList( flags ).contains( Flags.DIRTY );
		final boolean volatil = Arrays.asList( flags ).contains( Flags.VOLATILE );
